...
"UPDATE `schedules` 
    SET `name`= '$name', `serializedarray`= '$serializedarray', `updateddate`= '$current_time_stamp', `blocks`= '$serializedarray_blocks', `outline`= '$outline' WHERE `id` = '$id'"
);

$_SESSION['schedule_updated'] = "True";
header('location:editschedule.php?id='.$id);
