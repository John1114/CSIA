...
$result = mysqli_query($connect,
  ...
  { 
    $serializedoutline = $row['outline'];
  }
$outline = unserialize($serializedoutline);

  $name = $outline[0][0];
  $first_day = $outline[0][1];
  $last_day = $outline[0][2];
  $no_school_dates = $outline[0][3];
  $days_in_rotation = $outline[0][4];
  $blocks_in_a_day = $outline[0][5];
  $inclusive_dates = $outline[0][6];
  $inclusive_dates_array = explode(",", $inclusive_dates);
  $inclusive_days = count($inclusive_dates_array);
  $exclusive_dates = $outline[0][7];
  $exclusive_dates_array = explode(",", $exclusive_dates);
  $exclusive_days = count($exclusive_dates_array);

  $normal_rotation_saved = $outline[1][1];
  $wednesday_rotation_saved = $outline[1][0];
  $inclusive_rotation_saved = $outline[1][2];
  $exclusive_rotation_saved = $outline[1][3];
...
var rotation_displayed = true;
  <?php if (!isset($_GET['blocks'])) { ?>
          ...
          <!-- <div class="col-md-6"> -->
            <div class="col-md-8 offset-md-2">
              <div class="card">
                <div class="card-body">
                  <?php
        $schedule_updated = $_SESSION['schedule_updated'];
        if ($schedule_updated == "display") {
        echo '
            <div class="row my-3">
                <div class="col-12">
            ...
            ';
    unset($_SESSION['schedule_updated']);
    }; 
    if ($schedule_updated == "True") {
      $_SESSION['schedule_updated'] = "display";
    } ?> 
                  <div class="row justify-content-md-center">
                  <h1 id="cardHeader">Edit Schedule</h1>
                </div>
                  <br>
                      ...
                      <button type="button" id="createoutlinebutton" class="btn btn-blue btn-block btn-sm" onclick="show_outline();">Create Outline</button>
                      <br>
                      <div class="row">
                        <div class="col-12">
                          <div class="card">
                              ...
                              <ul class="nav nav-tabs">
                                ...
                                <div id='<?php echo("Day".$day_counter) ?>' class="tabcontent">
                                  ...
                                  <div class="input-group mb-1">
                                    <input type="text" class="form-control" placeholder="Name" id="<?php echo("Day".$day_counter."Block".$block_counter."Name") ?>" value="<?php echo($normal_rotation_saved[$day_counter-1][$block_counter-1][0]) ?>">
                                    <input type="text" class="form-control" placeholder="Time (HH:MM-HH:MM)" id="<?php echo("Day".$day_counter."Block".$block_counter."Time") ?>" value="<?php echo($normal_rotation_saved[$day_counter-1][$block_counter-1][1]) ?>">
                                  </div>
                                  <?php
                                  $block_counter += 1;
                                  }
                            ...
                            <div class="col-6">
                              ...
                              <ul class="nav nav-tabs">
                                ...
                                <div id='<?php echo("WDay".$day_counter) ?>' class="Wtabcontent">
                                  ...
                                  ?>
                                  <div class="input-group mb-1">
                                    <input type="text" class="form-control" placeholder="Name" id="<?php echo("WDay".$day_counter."Block".$block_counter."Name") ?>" value="<?php echo($wednesday_rotation_saved[$day_counter-1][$block_counter-1][0]) ?>">
                                    <input type="text" class="form-control" placeholder="Time (HH:MM-HH:MM)" id="<?php echo("WDay".$day_counter."Block".$block_counter."Time") ?>" value="<?php echo($wednesday_rotation_saved[$day_counter-1][$block_counter-1][1]) ?>">
                                  </div>
                                  <?php
                                  $block_counter += 1;
                                  }
                          ...
                          <h4 id="cardHeader">Special Days</h4>
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              <div id='<?php echo("SIDay".$day_counter) ?>' class="SItabcontent">
                                ...
                                ?>
                                <div class="input-group mb-1">
                                  <input type="text" class="form-control" placeholder="Name" id="<?php echo("SIDay".$day_counter."Block".$block_counter."Name") ?>" value="<?php echo($inclusive_rotation_saved[$day_counter-1][$block_counter-1][0]) ?>">
                                  <input type="text" class="form-control" placeholder="Time (HH:MM-HH:MM)" id="<?php echo("SIDay".$day_counter."Block".$block_counter."Time") ?>" value="<?php echo($inclusive_rotation_saved[$day_counter-1][$block_counter-1][1]) ?>">
                                </div>
                                <?php
                                $block_counter += 1;
                                }
                          ...
                          <div class="col-6">
                            ...
                            <ul class="nav nav-tabs">
                              ...
                              <div id='<?php echo("SEDay".$day_counter) ?>' class="SEtabcontent">
                                ...
                                ?>
                                <div class="input-group mb-1">
                                  <input type="text" class="form-control" placeholder="Name" id="<?php echo("SEDay".$day_counter."Block".$block_counter."Name") ?>" value="<?php echo($exclusive_rotation_saved[$day_counter-1][$block_counter-1][0]) ?>">
                                  <input type="text" class="form-control" placeholder="Time (HH:MM-HH:MM)" id="<?php echo("SEDay".$day_counter."Block".$block_counter."Time") ?>" value="<?php echo($exclusive_rotation_saved[$day_counter-1][$block_counter-1][1]) ?>">
                                </div>
                                <?php
                                $block_counter += 1;
                                }
                        ...
                        <!--    -->
                          ...
                          <br>
                          <form action="editcheduleprocess.php" method="POST" id="formtosubmit">

                          <input type="hidden" name="schedule_id" id="schedule_id" value="<?php echo($id); ?>"></input>
...
location.href="editschedule.php?blocks=".concat(document.getElementById("blocks_in_a_day").value, "&id=", <?php echo($id); ?>,"&days=", document.getElementById("days_in_rotation").value, "&inclusivedays=", inclusivedayscounter, "&exclusivedays=", exclusivedayscounter, "&inclusivedates=", inclusivedates, "&exclusivedates=", exclusivedates, "&name=",document.getElementById("schedule_name").value, "&first_day=", document.getElementById("first_day").value, "&last_day=", document.getElementById("last_day").value, "&no_school_dates=", document.getElementById("no_school_dates").value);
}

if (rotation_displayed == false) {
  document.getElementById("createoutlinebutton").click();
}
